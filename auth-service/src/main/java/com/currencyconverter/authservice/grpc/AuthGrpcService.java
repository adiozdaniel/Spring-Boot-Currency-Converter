package com.currencyconverter.authservice.grpc;
...
public class AuthGrpcService extends AuthServiceGrpc.AuthServiceImplBase {
        ...
        public void authenticate(AuthGrpcRequest request, StreamObserver<AuthGrpcResponse> responseObserver) {
                AuthRequest authRequest = new AuthRequest(request.getApiKey(), request.getClientId(),
                ...
                authenticationService.authenticate(authRequest, "gRPC")
                                ...
                                .subscribe(
                                                ...
                                                error -> responseObserver.onError(Status.INTERNAL
                                                                .withDescription(error.getMessage()).asException()),
                ...
                authenticationService.validateToken(request.getToken())
                                .map(claimsMap -> {
                                        ...
                                        if (rolesObj instanceof Iterable<?>) {
                                                for (Object item : (Iterable<?>) rolesObj) {
