package com.currencyconverter.mainservice.config;
...
public class KafkaConsumerConfig {
    ...
    private Map<String, Object> baseConsumerConfig() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.currencyconverter.mainservice.event,com.currencyconverter.authservice.event");
